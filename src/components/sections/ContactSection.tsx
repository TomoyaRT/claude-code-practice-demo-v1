...
const CONTACT_INFO = [
  { label: "Email",        value: "worth22focus3000@gmail.com", href: "mailto:worth22focus3000@gmail.com" },
  { label: "GitHub",       value: "github.com/TomoyaRT",        href: "https://github.com/TomoyaRT" },
  { label: "Location",     value: "Tokyo, Japan",               href: null },
  { label: "Availability", value: "Open for projects",          href: null },
] as const

export function ContactSection() {
  return (
    <section id="contact" className="py-32 px-6 border-t border-[--color-border]">
